...
def import_treat_modeled_NEX_GDDP_CMIP6(climate_var, unit,temporal_resolution,start_y,stop_y,csv_path,locNames):
    # import data
    
    #if climate_var =='pr':
    path_NEX_GDDP_CMIP6=os.path.join(csv_path,climate_var,climate_var+'_'+unit+'_'+temporal_resolution+'_'+str(start_y)+'-'+str(stop_y),climate_var+'_'+str(start_y)+'-'+str(stop_y)+locNames+'.csv')
    #else: # temperature
