# -*- coding: utf-8 -*-
"""
Created on Thu Oct 12 09:26:31 2023
...
def ET0(T,T_max,T_min,Rs,RH_mean,U_2,z_station_elevation,lat,month,Ra):
    ...
    albedo = 0.23 #albedo for green gras crop reference,FAO chap 3 #0.035 for the surface of water
    ...
    Rnl = Boltzman_constant*(((T_max+273.16)**4+(T_min+273.16)**4)/2)*(0.34-(0.14*e_a.apply(math.sqrt)))*(1.35*(Rs/Rs0)-0.35)
    
    G=0 #if looking at daily stuff
    ...
    ET0_value=((0.408*_delta*(R_n-G))+_gamma*(900/(T+273.16))*U_2*(e_s-e_a))/(_delta+_gamma*(1+0.34*U_2))
