...
def R_a_determination(lat,month):
...
def dataframe_Ra():
    path_Ra = r'C:\Users\CLMRX\OneDrive - COWI\Documents\GitHub\CRVA_tool\inputs\PET\Ra\Table2-Ra.csv'
...
def PET(T,T_max,T_min,Rs,RH_mean,U_2,z_station_elevation,lat,month):
    ...
    R_a = R_a_determination(lat,month)
